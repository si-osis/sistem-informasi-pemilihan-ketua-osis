...
<html>
    <head>
        <title>Cetak Data Semua Pengumuman Kriteria</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA SELURUH PENGUMUMAN KRITERIA</h3>
                        <table class="table table-bordered table-striped table-hover">
                        <tbody>
                                <thead>
								<tr>
									<th>No.</th><th width="18%">Nama Calon</th><th>Kelas</th><th>Nilai</th><th>Hasil Persentasi</th><th>Kategori</th>
								</tr>
								</thead>
							<tbody>
