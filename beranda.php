    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang di SI Pemilihan Ketua OSIS SMA XYZ</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Data Calon Osis</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="30%">Nama Calon</th><th>Kepemimpinan</th><th>Pengetahuan dan Skill</th><th>Tanggung Jawab</th><th>Kedisiplinan</th><th>Status</th>
                            </tr>
                        </thead>
                        <tbody>
