        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="fa fa-user-plus"></span> Laporan Kriteria</h3>
                </div>
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="17%">Nama Calon</th><th>Kepemimpinan</th><th width="15%">Pengetahuan dan Skill></th><th width="10%">Tanggung Jawab</th><th>Kedisiplinan</th><th>Status</th><th>Total</th><th>AKSI</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td><?= $data['status'] ?></td>
									                  <td><?= $data['total'] ?></td>
                                    <td>
                                        <a href="report/kriteria_satu.php?id=<?= $data['id'] ?>" target="_blank" class="btn btn-info btn-xs">
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="9">
                                    <a href="report/kriteria_semua.php" target="_blank" class="btn btn-info btn-sm">
